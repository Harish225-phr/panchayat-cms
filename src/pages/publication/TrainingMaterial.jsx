...
function TrainingMaterialRules() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await bindPageClick('Training-Material');
  ...
  return (
    ...
    <div className="container mt-2 FontSize rich-text-container table">
      <h6 className=" fw-bold mt-4">Training Material:-</h6>
...
export default 	TrainingMaterialRules;
