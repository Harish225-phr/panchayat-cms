...
function OrganizationOfPanchayat() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await bindPageClick('Panchayat-org');
  ...
  return (
    ...
    <div className="container mt-2 FontSize rich-text-container table">
      <h6 className=" fw-bold mt-4">Organization Of Panchayat :-</h6>
...
export default OrganizationOfPanchayat;
